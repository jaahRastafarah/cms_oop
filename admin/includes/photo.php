...
class Photo extends Db_object {
    ...
    public $upload_errors_array = array(
        ...
        UPLOAD_ERR_INI_SIZE => "The upload file exceeds the upload_max_file",
        UPLOAD_ERR_FORM_SIZE => "The upload file exceeds the MAX-FILE_SIZE",
         ...
         if($this->id){
            $this->update();
              ...
              if(move_uploaded_file($this->tmp_path, $target_path)){
                  ...
                  $this->errors[] = "The folder 'images' doesnt have permission";
                  return false;
              }
