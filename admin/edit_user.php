            ...
            <div class="row">
              ...
              <form action=""  method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                          <a id="user-id" class="btn btn-primary" href="delete_user.php?id=<?php echo $user->id;  ?>">Delete</a>
                         <input type="submit" name="update" class="btn btn-danger pull-right" value="Update">
